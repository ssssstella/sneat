    ...
    'activity': [
        ...
        {'title': 'Client Meeting', 
         'content': {'desc': 'Project meeting with john @10:15am', 
                     'members': [{'name': 'Steven Nash (Client)', 'icon': 'avatar2.png', 'position': 'CEO of ThemeSelection'}]}, 
         'timestamp': '45 min ago'},
        {'title': 'Create a new project for client', 
         'content': {'desc': '5 team members in a project', 
                    'members': [{'name': 'Howard Lloyd', 'icon': 'avatar3.png'},
                                {'name': 'Katie Lane', 'icon': 'avatar4.png'},
                                {'name': 'George Allen', 'icon': 'avatar5.png'},
                                {'name': 'Alice Cobb', 'icon': 'avatar6.png'},
                                {'name': 'Jeffrey Warner', 'icon': 'avatar7.png'}]}, 
